...
export default function SelectTraveler() {
    ...
    const [selectedTraveler, setSelectedTraveler] = useState(tripData.travelers);
    ...
    return (
        <View style={styles.page}>
            ...
            <FlatList
                ...
                keyExtractor={(item) => item.id.toString()} // Ensure to provide a unique key
            />

            <TouchableOpacity onPress={setTripDetails} style={styles.button}>
